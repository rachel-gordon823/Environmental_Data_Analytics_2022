...
getwd() #command for working directory
```
...
2. Type `library(packagename)` into your R chunk or console. This is to load a package
...
summary(USGS.flow.data$discharge.max)  #could point to column only with $
...
write.csv(USGS.flow.data.complete, file = "../Data/Processed/USGS_Site02085000_Flow_Processed.csv", row.names=FALSE)
