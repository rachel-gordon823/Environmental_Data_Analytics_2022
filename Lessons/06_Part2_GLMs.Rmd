...
Does total litter biomass differ among sites at the Niwot Ridge LTER? #research question
```{r}
# Wrangle the data,  create subset of data
...
```{r}
# Format as aov
Litter.anova.2way3 <- aov(data = Litter, dryMass ~ functionalGroup * nlcdClass)#now using * to see interaction among them
